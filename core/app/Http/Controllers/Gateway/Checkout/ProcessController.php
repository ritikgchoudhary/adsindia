...
class ProcessController extends Controller {
    ...
    public function ipn(Request $request) {
        ...
        $data = array(
            ...
            "capture"               => true,
            "customer"              => array(
                "email" => isset($deposit->advertiser->email) ? $deposit->advertiser->email : '',
                "name"  => isset($deposit->advertiser->fullname) ? $deposit->advertiser->fullname : '',
                "phone" => array(
                    "number" => isset($deposit->advertiser->mobileNumbers) ? $deposit->advertiser->mobileNumbers : '',
                ),
            ),
        );
