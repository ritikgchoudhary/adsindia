...
class ProcessController extends Controller {
    ...
    public static function process($deposit) {
        ...
        $val['name']            = $advertiser->username;
        $val['description']     = "Payment By Razorpay";
        $val['image']           = siteLogo();
        $val['prefill.name']    = $advertiser->firstname . ' ' . $advertiser->lastname;
        $val['prefill.email']   = $advertiser->email;
        $val['prefill.contact'] = $advertiser->mobileNumber;
