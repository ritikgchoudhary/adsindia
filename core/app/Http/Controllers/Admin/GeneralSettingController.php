...
class GeneralSettingController extends Controller {
    ...
    public function systemConfigurationSubmit(Request $request) {
        ...
        $general->advertiser_registration = $request->advertiser_registration ? Status::ENABLE : Status::DISABLE;
        $general->advertiser_kv           = $request->advertiser_kv ? Status::ENABLE : Status::DISABLE;
        $general->save();
