                                ...
                                @forelse($loginLogs as $log)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span class="small"> <a href="{{ route('admin.advertisers.detail', $log->advertiser_id) }}"><span>@</span>{{ $log?->advertiser?->username }}</a> </span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="{{ route('admin.advertiser.report.login.ipHistory', [$log->advertiser_ip]) }}">{{ $log->advertiser_ip }}</a>
                                            </span>
                                        </td>
