                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($transactions as $trx)
                                    <tr>
                                        <td>
                                            <span class="fw-bold">{{ $trx?->advertiser?->fullname }}</span>
                                            <br>
                                            <span class="small"> <a href="{{ appendQuery('search', $trx?->advertiser?->username) }}"><span>@</span>{{ $trx?->advertiser?->username }}</a> </span>
                                        </td>
