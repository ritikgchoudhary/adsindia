                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-4 col-sm-6">
                                <label class="required"> @lang('System Affiliate Commission')</label>
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control" name="system_affiliate_commission" value="{{ getAmount(gs('system_affiliate_commission')) }}">
