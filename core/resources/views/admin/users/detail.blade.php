    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.commission.log') }}?search={{ $user->username }}" title="Total Commission" icon="las la-wallet" value="{{ showAmount($totalCommission) }}" bg="8" type="2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
