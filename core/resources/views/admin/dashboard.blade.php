...
@section('panel')
    ...
    <div class="row mt-2 gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" outline="true" link="{{ route('admin.advertisers.all') }}" icon="las la-users" title="Total Advertisers" value="{{ $widget['total_advertisers'] }}" bg="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" outline="true" link="{{ route('admin.advertisers.active') }}" icon="las la-user-check" title="Active Advertisers" value="{{ $widget['verified_advertisers'] }}" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" outline="true" link="{{ route('admin.advertisers.email.unverified') }}" icon="lar la-envelope" title="Email Unverified Advertisers" value="{{ $widget['email_unverified_advertisers'] }}" bg="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" outline="true" link="{{ route('admin.advertisers.mobile.unverified') }}" icon="las la-comment-slash" title="Mobile Unverified Advertisers" value="{{ $widget['mobile_unverified_advertisers'] }}" bg="warning" />
        </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      style="7"
                      link="{{ route('admin.campaign.pending') }}"
                      title="Pending Campaigns"
                      icon="las la-spinner"
                      value="{{ $widget['pending_campaigns'] }}"
                      bg="warning"
                      type="2" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      style="7"
                      link="{{ route('admin.campaign.approved') }}"
                      title="Approved Campaigns"
                      icon="las la-check-circle"
                      value="{{ $widget['approved_campaigns'] }}"
                      bg="success"
                      type="2" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      style="7"
                      link="{{ route('admin.campaign.rejected') }}"
                      title="Rejected Campaigns"
                      icon="las la-times-circle"
                      value="{{ $widget['rejected_campaigns'] }}"
                      bg="danger"
                      type="2" />
        </div><!-- dashboard-w1 end -->
    </div>
