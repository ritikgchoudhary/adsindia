        ...
        <div class="social-login-wrapper">
            ...
            <ul class="social-login-list">
                ...
                @if ($socials->facebook->status == Status::ENABLE)
                    <li class="social-login-list__item">
                        <a href="{{ route('user.social.login', 'facebook') }}" class="w-100 social-login-btn facebook">
                            <span class="social-login-btn__icon">
                ...
                @if ($socials->linkedin->status == Status::ENABLE)
                    <li class="social-login-list__item">
                        <a href="{{ route('user.social.login', 'linkedin') }}" class="w-100 social-login-btn linkedin">
                            <span class="social-login-btn__icon">
