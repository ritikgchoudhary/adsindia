            ...
            <div class="row gy-4">
                ...
                <div class="col-12 mt-5">
                    @if (auth()->guard('advertiser')->user()->ts)
                        ...
                        <form action="{{ route('advertiser.twofactor.disable') }}" method="POST" class="twofa-enable-wrapper">
                            @csrf
                    ...
                    @else
                        ...
                        <form action="{{ route('advertiser.twofactor.enable') }}" method="POST" class="twofa-enable-wrapper">
                            @csrf
                            <input type="hidden" name="key" value="{{ $secret }}">
                            <div class="form-group mb-3">
