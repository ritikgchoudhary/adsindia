...
@section('content')
    <div class="d-flex justify-content-end align-items-center mb-4">
        <a href="{{ route('advertiser.campaign.index') }}" class="btn btn--base">
                    ...
                    <tbody>
                        @forelse ($conversions as $conversion)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn--sm btn-outline--base viewConversionBtn" data-resource="{{ json_encode($conversion) }}" data-user="{{ json_encode($conversion->user) }}">
