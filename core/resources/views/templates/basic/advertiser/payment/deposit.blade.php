                        ...
                        <div class="row justify-content-center gy-sm-4 gy-3">
                                        ...
                                        <label for="account_balance" class="payment-item gateway-option">
                                            <div class="payment-item__info">
                                                ...
                                                <span class="payment-item__name">
                                                    @lang('Account Balance') ({{ showAmount(auth()->guard('advertiser')->user()->balance) }})
                                                </span>
                                            </div>
                                            <div class="payment-item__thumb">
                                                <img class="payment-item__thumb-img" src="{{ getImage(null, avatar: true) }}" alt="@lang('account-balance')">
                                            </div>
                                            <input class="payment-item__radio gateway-input" id="account_balance"
                                                   hidden type="radio" name="gateway" value="wallet"
                                                   @if (old('gateway') == 'wallet') checked @endif>
                                        </label>
                                    @endif
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list p-3">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('amount', isset($campaign) ? getAmount($campaign->budget) : '') }}"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="deposit-info mb-3">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon mb-1">@lang('Limit') <span></span></p>
                                        </div>
                                        <div class="deposit-info__input">
                                    ...
                                    <button type="submit" class="btn btn--base w-100 mb-3" disabled>
        ...
        (function($) {
            ...
            function gatewayChange() {
                ...
                if (methodCode === 'wallet') {
                    @if (isset($campaign))
                        let walletBalance = parseFloat('{{ auth()->guard('advertiser')->user()->balance }}');
                        let campaignBudget = parseFloat('{{ getAmount($campaign->budget) }}');

                        if (campaignBudget > walletBalance) {
                            $(".deposit-form button[type=submit]").attr('disabled', true);
                        } else {
                            $(".deposit-form button[type=submit]").removeAttr('disabled');
                        }

                        var totalAmount = campaignBudget;
