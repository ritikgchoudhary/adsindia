...
@section('content')
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <form action="{{ route('advertiser.withdraw.money') }}" method="post" class="withdraw-form">
                    @csrf
                        ...
                        <div class="row justify-content-center gy-sm-4 gy-3">
                                    ...
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}" hidden
                                                   data-gateway='@php echo json_encode($data) @endphp' type="radio" name="method_code" value="{{ $data->id }}"
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list p-3">
                                    ...
                                    <div class="deposit-info mb-3">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon mb-1">@lang('Limit')</p>
                                        </div>
                                        <div class="deposit-info__input">
                                    ...
                                    <div class="deposit-info mb-3">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon mb-1">
                                                ...
                                                <span data-bs-toggle="tooltip" title="@lang('Processing charge for withdraw method')" class="proccessing-fee-info">
                                    ...
                                    <div class="deposit-info total-amount pt-3 mb-3">
                                        ...
                                        <div class="deposit-info__input">
                                            <p class="text">
                                                {{ gs('cur_sym') }}<span class="final-amount">@lang('0.00')</span> {{ __(gs('cur_text')) }}
                                            </p>
                                        </div>
                                    </div>
