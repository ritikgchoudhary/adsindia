...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageAdvertisersController')->name('advertisers.')->prefix('advertisers')->group(function () {
        ...
        Route::get('active', 'activeAdvertisers')->name('active');
        Route::get('banned', 'bannedAdvertisers')->name('banned');
        Route::get('email-verified', 'emailVerifiedAdvertisers')->name('email.verified');
        ...
        Route::get('kyc-unverified', 'kycUnverifiedAdvertisers')->name('kyc.unverified');
        Route::get('kyc-pending', 'kycPendingAdvertisers')->name('kyc.pending');
        Route::get('mobile-verified', 'mobileVerifiedAdvertisers')->name('mobile.verified');
        Route::get('with-balance', 'advertisersWithBalance')->name('with.balance');
    ...
    Route::controller('CampaignController')->name('campaign.')->prefix('campaign')->group(function () {
        ...
        Route::get('paused', 'paused')->name('paused');

        Route::get('details/{id}', 'details')->name('details');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('toggle-pause/{id}', 'togglePause')->name('toggle.pause');
    ...
    Route::controller('TrafficTypeController')->name('traffic.')->prefix('traffic')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    Route::controller('AdvertiserReportController')->prefix('advertiser/report')->name('advertiser.report.')->group(function () {
        Route::get('transaction/{advertiser_id?}', 'transaction')->name('transaction');
        Route::get('login/history', 'loginHistory')->name('login.history');
        Route::get('login/ipHistory/{ip}', 'loginIpHistory')->name('login.ipHistory');
        Route::get('notification/history', 'notificationHistory')->name('notification.history');
        Route::get('email/detail/{id}', 'emailDetails')->name('email.details');
    ...
    Route::controller('KycController')->group(function () {
        ...
        Route::get('advertiser/kyc-setting', 'advertiserSetting')->name('advertiser.kyc.setting');
        Route::post('advertiser/kyc-setting', 'advertiserSettingUpdate')->name('advertiser.kyc.setting');
    });
