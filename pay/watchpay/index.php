...
if ($demoResult && $demoResult->num_rows > 0) {
    ...
    header('Location: https://a22-com.site/#/wallet/RechargeHistory');
    exit;
}
...
$params = [
    "version"       => "1.0",
    "mch_id"        => "100225567",
    "notify_url"    => "https://a22-com.site/pay/watchpay/callback.php",
    "page_url"      => "https://a22-com.site/#/wallet/RechargeHistory",
